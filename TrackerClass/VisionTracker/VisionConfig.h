#ifndef _VISION_CONFIG_
#define _VISION_CONFIG_

/*vex-vision-config:begin*/
#include "../include/vex.h"
vex::vision::signature BALL_GREEN = vex::vision::signature (1, -4889, -4375, -4632, -3139, -2191, -2665, 3, 0);
