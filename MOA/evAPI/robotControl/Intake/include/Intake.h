...
namespace evAPI
{
  class Intake
  {
    ...
    public:
      Intake(int32_t motorPort, bool reversed = false);
      Intake(int32_t motorPort, gearSetting gears, bool reversed = false);
      Intake(int32_t firstMotorPort, int32_t secondMotorPort, bool firstMotorReversed = false, bool secondMotorReversed = false);
      Intake(int32_t firstMotorPort, int32_t secondMotorPort, gearSetting firstMotorGears, gearSetting secondMotorMotorGears, bool firstMotorReversed = false, bool secondMotorReversed = false);
      ~Intake();
